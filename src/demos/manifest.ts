...
export const demos: Demo[] = [
  ...
  {id:'chadcn:ai-chat-bar',title:'AI chat bar',family:'AI chat bar',source:'chadcn',kind:'Block',description:'A glass composer with plan/ask/build modes, a searchable showcase model menu, @ context, file and audio attachments, and a local send queue. No model API is connected.',importPath:'@chadcn/ui/ai-chat-bar',load:()=>import('./StudioExamples').then(m=>({default:m.ChatBarDemo}))},
  {id:'chadcn:ai-todo-list',title:'AI to-do list',family:'AI to-do list',source:'chadcn',kind:'Block',description:'An animated task sequence with elapsed time, token usage, and collapse on completion. Replay by resetting the demo.',importPath:'@chadcn/ui/ai-todo-list',load:()=>import('./StudioExamples').then(m=>({default:m.TodoListDemo}))},
  {id:'chadcn:schema-builder',title:'Schema builder',family:'Schema builder',source:'chadcn',kind:'Block',description:'A visual and JSON editor for a strict object-schema subset. Unsupported keywords are rejected instead of silently dropped.',importPath:'@chadcn/ui/schema-builder',load:()=>import('./StudioExamples').then(m=>({default:m.SchemaBuilderDemo}))},
  {id:'chadcn:studio-lab',title:'Studio lab',family:'Studio lab',source:'chadcn',kind:'Block',description:'Three authored compositions together: chat bar, task list, and schema builder. Local interactions only.',importPath:'@chadcn/ui/ai-chat-bar',load:()=>import('./StudioExamples')},
